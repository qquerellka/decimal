...
// uint32_t s21_get_float_scale_and_mantisa(s21_FloatUint32_t float_box,
// s21_FloatDescriptor_t *float_descriptor);
// s21_FloatDescriptor_t s21_get_float_data(s21_FloatUint32_t float_box);
// void s21_set_float_sign(s21_FloatDescriptor_t *float_descriptor, uint32_t
// *dst); void s21_set_float_scale(s21_FloatDescriptor_t *float_descriptor,
//                          uint32_t *dst);
